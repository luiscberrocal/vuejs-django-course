...
<template>
  ...
  <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10">
    <Trend title="Income" color="green" :amount="3000" last-amount="5000" :loading="isLoading"/>
    <Trend title="Expense" color="red" :amount="3000" last-amount="3000" :loading="isLoading"/>
